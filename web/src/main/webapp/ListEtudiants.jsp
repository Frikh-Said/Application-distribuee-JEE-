...
<body>
	<center>
		...
		<h2>
			<a href="/web?action=new">Add New Etudiant</a>
			&nbsp;&nbsp;&nbsp; <a href="/web">List of
				Etudiants</a>
		...
		<table border="1" cellpadding="5">
			...
			<c:forEach var="etudiant" items="${listEtudiant}">
				<tr>
					...
					<td><a
						href="/web?action=edit&id=<c:out value='${etudiant.id_etudiant}' />">Edit</a>
						&nbsp;&nbsp;&nbsp;&nbsp; <a
						href="/web?action=delete&id=<c:out value='${etudiant.id_etudiant}' />">Delete</a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
